...
7. Pour utiliser les variables de session :
   ...
   - commencer par `session_start()`, définir (et initialiser) les variables de session pour chaque arme :
    ...
    - Modifier les variables de session lorsque le formulaire à été soumis :
    ...
    - Mettre à jour les `level`odifier les variables de session lorsque le formulaire à été soumis :
